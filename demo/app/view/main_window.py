...
from .ImageMosaic import ImageMosaic   # 菜单
from .setting_interface import SettingInterface # 设置-Setting
from .tudifenlei import Tudifenlei_interface # 设置-Setting
...
class MainWindow(FluentWindow):
    ...
    def __init__(self):
        ...
        self.ImageMosaic = ImageMosaic (self)
        self.settingInterface = SettingInterface(self)
        self.tudishibieInterface = Tudifenlei_interface(self)
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.ImageMosaic, FIF.PALETTE, t.mosaic, pos)  # 菜单
        # Icon.MENU
        self.addSubInterface(self.tudishibieInterface, FIF.IOT, t.tudi, pos,)
        self.addSubInterface(self.menuInterface, FIF.APPLICATION, t.menus, pos, )  # 菜单
        # 在底部添加自定义小部件
        self.navigationInterface.addWidget(
            routeKey='avatar',
            widget=NavigationAvatarWidget('AJC',  resource_path('photos/resource/header/AJC666.jpg')),
    ...
    def initWindow(self):
        ...
        self.setWindowIcon(QIcon(resource_path('Photos/resource/遥感测绘.png')))  # 设置窗口图标
    ...
    def onSupport(self):
        w = MessageBox(
            'Member：彭于晏 吴彦祖 AJC(最帅的都是压轴出场)',
            '遥感数字图像处理与分析作业！！٩(^ω^*)و',
            self
        )
        w.yesButton.setText('恭喜发财!')
        w.cancelButton.setText('下次再见')
        if w.exec():
            SUPPORT_URL2 = 'https://www.bilibili.com/video/BV187411i71P/?vd_source=1b6364de1cc9d7282046f87860d47886'
